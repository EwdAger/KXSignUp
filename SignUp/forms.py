...
class ContactForm(forms.Form):
    ...
    first_choice = forms.ChoiceField(choices=WISH_CHOICE1, label=u'第一志愿')
    second_choice = forms.ChoiceField(choices=WISH_CHOICE2, label=u'第二志愿')
